...
class LlamaFineTuner:
    ...
    def train_model(self):
        ...
        def tokenize_function(examples):
            # Properly tokenize the text with padding and truncation handling
            # This ensures consistency between training and embedding extraction
            return self.tokenizer(
                examples["speaker_text"], 
                padding="max_length",
                truncation=True, 
                max_length=2048,
                return_tensors="pt"
...
if __name__ == "__main__":
    ...
    lora_model_path = "./results/lora_llama3.1_8b_0655"
